...
ActiveRecord::Schema.define(version: 20_200_229_124_626) do
  ...
  create_table 'category_mches', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    t.bigint 'category_id'
    t.bigint 'mch_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['category_id'], name: 'index_category_mches_on_category_id'
  ...
  create_table 'lab_forums', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    t.string 'question'
    t.text 'description'
  ...
  create_table 'likes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.bigint 'expressable_id'
    t.bigint 'user_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[expressable_type expressable_id], name: 'index_likes_on_expressable_type_and_expressable_id'
