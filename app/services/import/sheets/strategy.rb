...
module Import
  module Sheets
    module Strategy
      ...
      def get_sty_flow
        return @cls::STRATEGY if @cls.const_defined?(:STRATEGY)
      ...
      def sty_sheet_info=(sheet_info = nil)
      ...
      def sty_column_info=(column_info = nil)
      ...
      def sty_data_handler=(data_handler = nil)
